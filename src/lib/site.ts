  ...
  projects: [
    {
      ...
      summary:
        "분산 운영 중이던 Jenkins 환경을 중앙 집중화하고, 배치 작업 전 과정에 내부 통제를 적용한 운영 체계를 구축했습니다.",
      tags: ["Jenkins", "Python", "ITGC", "Compliance"],
      highlights: [
        "직무 분리 원칙에 따른 승인·변경 이력 관리로 통제 강화",
        "서비스 연속성 확보 및 리스크 관리",
    ...
    },
    {
      ...
      name: "AI 브라우저 확장앱 구현",
      summary:
        "요청서/이슈 형식이 불규칙한 환경에서 AI을 활용해 코멘트 생성·등록을 자동화했습니다.",
    ...
    },
    {
      ...
      highlights: [
        "Jenkins DR 오탐 전환 방지 자동화(리전 간 단절 Failover 오탐 방지)",
        "Sentry 부하 테스트 앱 구현(초당 2,000+ 트래픽, Kubernetes Job)",
